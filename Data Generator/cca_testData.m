...
%   FLAG == 5,
%   Lap-SBL paper consistent simulation model
%   Liu K, Lai Q, Li P, et al. Robust Bayesian estimation of EEG-based brain causality networks[J]. IEEE Transactions on Biomedical Engineering, 2022.
...
elseif FLAG == 5   % LAP-SBL paper consistent simulation model
